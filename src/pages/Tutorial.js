  ...
  <>
    <section>
      ...
      <p>
        ...
        details of setting up Node/Express. The docs provide great instructions
        and there are free tutorials available. You can also find the source
        code for this entire api tutorial{" "}
    ...
    <section>
      ...
      <ol>
        ...
        <li>
          ...
          contain the data you're trying to scrape. Does it have selectors that
  ...
  return request
    ...
    <section>
      ...
      <p>
        ...
        the MongoDB docs could use some work. Please reference their
...
scrapeData()
  ...
  .finally(() => mongoose.connection.close()); `}</code>
    ...
    <section>
      ...
      <p>
        ...
        .<br />
        This section will just be a summary of the functionality of each of our
        routes.
      </p>
      <h4>Hot Tip</h4>
      <p>
        We recommend thinking of your users and data. What data would your users
        want? If you have <i>a lot</i> of data, consider pagination as an
  ...
  Character
    ...
    <section>
      ...
      <p>
        Take the time to document your application either in a README or create
        a front end! Provide information on your routes and what type of data
